...
class MazeTest {
    ...
    public void testMainMethod(RepetitionInfo repetitionInfo) {
        Logger LOGGER = LoggerFactory.getLogger(MazeTest.class);
...
//            Walk.main(new String[]{});

            org.example.Solution.Maze solutionWalk = new org.example.Solution.Maze();
...
class ActualOutputCalculator{
    public static String calculateActualOutput(String input) {
        ...
        try {
            ...
            org.example.Tester.Maze testerWalk = new org.example.Tester.Maze();
